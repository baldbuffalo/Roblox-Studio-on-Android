...
// Vendored into the app module directly (see MainActivity.java for why),
// so this must explicitly import the app's own R class rather than relying
// on same-package resolution, which only worked when this was a standalone
// library module with its own generated R.
import com.example.exeunpacker.R;
